...
<main class="content-wrapper">
  ...
  <section class="etapa-section">
    ...
    <p>Recomendamos firmemente el uso del <a href="{{ '/antimetodo-tracker-app' | relative_url }}"><strong>Antimétodo Tracker</strong></a> o <a href="https://play.google.com/store/apps/details?id=com.refoldla.habitsmobile&hl=en" target="_blank" rel="noopener noreferrer">Refold Tracker</a>. Es una aplicación que te permite registrar el tiempo que pasas en tu idioma y en qué actividades. Te ayudará a crear el hábito y a tener claridad sobre tus horas reales de exposición.</p>
