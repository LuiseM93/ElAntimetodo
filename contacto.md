...
<main class="content-wrapper"> 
  ...
  <section class="about-me-container">
    ...
    <div class="about-me-text">
      ...
      <p style="font-size: 1.1em; line-height: 1.7; color: var(--text-light-color);">
        ...
        <br><br>
        <a href="#contacto" style="font-size: 0.9em; color: var(--secondary-color); text-decoration: underline;">¿Quieres contactarme? Ir abajo ↓</a>
      </p>
    </div>
  </section>
  ...
  <section id="contacto" class="contact-section-card" style="margin-top: 5rem;">
